...
# it is associated with. It requires a diffbot.com api token key with the 
# provision to make more than 5000 api calls.
###############################################################################
    ...
    for genre_url in genre_url_list:
        ...
        for idx in range(num_pages):
            ...
            for poster_link in poster_links:
                clips_url_list[str(counter)] = {"genre":genre, "page_url":poster_link}
                counter += 1
